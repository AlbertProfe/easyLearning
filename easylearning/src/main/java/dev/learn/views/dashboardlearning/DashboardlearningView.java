package dev.learn.views.dashboardlearning;

import dev.learn.views.dashboardlearning.ServiceHealth.Status;
...
@RolesAllowed("USER")
public class DashboardlearningView extends Main {

    public DashboardlearningView() {
        addClassName("dashboardlearning-view");
